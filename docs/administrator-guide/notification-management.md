...
6. To be more specific, you can add filters as well. You can either include or exclude the particular filter by adding its type or name. For now, we have 10 types of filters including some custom fields as well :
   * Affects versions
   * Epic Link
   * Fix versions
   * Labels
